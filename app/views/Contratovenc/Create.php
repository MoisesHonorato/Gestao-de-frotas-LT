<div class="page-title">
    <div class="title_left">
        <h3><i class="fa fa-file-text-o"></i> Contrato </h3>
    </div>
    <!-- botão adicionar -->
    <div class="title_right">
        <div class="col-md-3 col-sm-3 col-xs-12 pull-right">
            <div class="input-group">
                <a href="<?php echo URL_BASE . 'contrato'; ?>" class="btn btn-outline-secondary">
    ...
    <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <form action="<?php echo URL_BASE . 'contrato/salvar' ?>" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                    <div class="form-group row">
                        ...
                        <div class="mb-3 col-md-2">
                            ...
                            <input type="text" name="valormobilizacao" require class="form-control" value="<?php echo ($contrato->valormobilizacao) ? $contrato->valormobilizacao : NULL; ?>">
                        </div>
                        <div class="mb-3 col-md-2">
                            <label for="exampleFormControlInput1" require class="form-label">Desmobilização (R$) *</label>
                            <input type="text" name="valordesmobilizacao" class="form-control" id="exampleFormControlInput1" value="<?php echo ($contrato->valordesmobilizacao) ? $contrato->valordesmobilizacao : NULL; ?>">
                        </div>
                        <div class="mb-3 col-md-3">
